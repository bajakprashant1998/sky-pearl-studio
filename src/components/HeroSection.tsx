            ...
            >
              {[...clients, ...clients, ...clients].map((client, index) => (
                <div
                  ...
                  className="flex-shrink-0 w-24 h-14 rounded-xl bg-card border border-border flex items-center justify-center text-sm font-bold text-primary/70 hover:text-primary hover:border-primary/30 hover:shadow-md transition-all"
                  title={client.name}
                >
                  {client.logo}
                </div>
