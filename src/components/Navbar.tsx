      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <Link
              to="/"
              className={`px-4 py-2 rounded-lg ${navLinkClass(location.pathname === "/")}`}
            >
              Home
            </Link>
                            ...
                            {trendingServices.map((ts, index) => (
                              ...
                              >
                                <Link
                                  ...
                                  className={`px-3 py-1.5 rounded-full text-xs font-medium text-white bg-gradient-to-r ${ts.color} hover:shadow-lg hover:scale-105 transition-all flex items-center gap-1`}
                                >
                            ...
                            {activeService && (
                              ...
                              >
                                  ...
                                  <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <Link
                                        ...
                                        className="inline-flex items-center gap-1 text-sm font-semibold text-primary hover:underline mt-2 group"
                                        onClick={() => setServicesOpen(false)}
                                      >
                                        Explore Service 
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                  {activeService.subcategories.slice(0, 6).map((sub, index) => (
                                    <motion.div
                                      key={sub.id}
                                ...
                                {activeService.subcategories.length > 6 && (
                                  <Link
                                    to={`/services/${activeService.slug}`}
                                    onClick={() => setServicesOpen(false)}
                                    className="inline-flex items-center gap-2 text-sm text-primary font-medium hover:underline group"
                                  >
            ...
            <Link
              to="/free-tools"
              className={`flex items-center gap-1.5 px-4 py-2 rounded-lg ${navLinkClass(location.pathname === "/free-tools")}`}
            >
            ...
            >
              ...
              Academy
              <motion.span 
                className="absolute -top-1 -right-1 text-[9px] bg-gradient-to-r from-primary to-accent text-white px-1.5 py-0.5 rounded-full font-bold shadow-md"
            ...
            >
              <button 
                className={`flex items-center gap-1.5 px-4 py-2 rounded-lg ${navLinkClass(
            ...
            <Link
              to="/blog"
              className={`flex items-center gap-1.5 px-4 py-2 rounded-lg ${navLinkClass(location.pathname.includes("/blog"))}`}
            >
            ...
            <Link
              to="/contact"
              className={`flex items-center gap-1.5 px-4 py-2 rounded-lg ${navLinkClass(location.pathname === "/contact")}`}
            >
