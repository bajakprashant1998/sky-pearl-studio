  ...
  return (
    <section className="py-24 bg-gradient-primary relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <motion.div 
          className="absolute top-0 left-0 w-96 h-96 bg-primary-foreground/20 rounded-full blur-3xl"
          animate={{ 
            x: [-20, 20, -20],
            y: [-10, 10, -10],
          }}
        ...
        />
        <motion.div 
          className="absolute bottom-0 right-0 w-96 h-96 bg-primary-foreground/20 rounded-full blur-3xl"
          animate={{ 
            x: [20, -20, 20],
            y: [10, -10, 10],
          }}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection>
          <div className="text-center mb-12">
            <motion.div 
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary-foreground/10 rounded-full border border-primary-foreground/20 mb-4"
            ...
            <AnimatedSection key={stat.label} delay={0.1 * index}>
              ...
              >
                ...
                <div className="relative w-16 h-16 mx-auto mb-6">
                  <motion.div 
                    className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${stat.color} opacity-20`}
                ...
                {/* Bottom accent line */}
                <motion.div 
                  className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-1 bg-gradient-to-r ${stat.color} rounded-t-full`}
                  initial={{ width: 0 }}
