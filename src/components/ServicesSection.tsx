            ...
            <div className="flex flex-wrap justify-center gap-4">
              {services.slice(8).map((service, index) => (
                ...
                >
                  <Link
                    to={`/services/${service.slug}`}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-full text-sm font-medium text-muted-foreground hover:text-primary hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 transition-all group"
                  >
