...
import { GraduationCap, CheckCircle2, Clock, IndianRupee, Users, Award, BookOpen, Palette, TrendingUp, Briefcase, Mail, Phone, ArrowRight, Sparkles, Target, Globe, Search, Share2, BarChart3, FileText, Zap, Brain, Star, Building2, Laptop, Film, Shield, HeartHandshake, Rocket, MousePointerClick, CircleDollarSign, Heart, UserCheck, Play, Calendar, ExternalLink, MessageCircle } from "lucide-react";
...
const DigitalMarketingAcademy = () => {
  ...
  const courseDetails = [{
    ...
    icon: BookOpen,
    label: "Training Type",
    value: "Practical + Live Projects",
    color: "from-amber-500 to-orange-500",
    gradient: "from-amber-500 to-orange-500"
  }];
  const benefits = [{
    icon: Sparkles,
    text: "AI-Integrated Syllabus",
    desc: "Latest Digital Marketing + AI integrated curriculum",
    slug: "ai-integrated-syllabus",
    gradient: "from-violet-500 to-purple-600"
  }, {
    icon: Clock,
    text: "6-Month In-Depth Training",
    desc: "Comprehensive training from basics to advanced level",
    slug: "in-depth-training",
    gradient: "from-blue-500 to-cyan-500"
  }, {
    icon: Target,
    text: "Daily Practical Sessions",
    desc: "Hands-on experience with real tools & examples",
    slug: "daily-practical-sessions",
    gradient: "from-green-500 to-emerald-500"
  }, {
    icon: Award,
    text: "Expert Industry Trainers",
    desc: "Learn from professionals with real-world experience",
    slug: "expert-trainers",
    gradient: "from-amber-500 to-orange-500"
  }, {
    icon: Users,
    text: "Small Batch Sizes",
    desc: "Personalized attention in every session",
    slug: "small-batch-sizes",
    gradient: "from-rose-500 to-pink-500"
  }, {
    icon: Briefcase,
    text: "Portfolio Development",
    desc: "Build a professional portfolio for career success",
    slug: "portfolio-development",
    gradient: "from-indigo-500 to-violet-500"
  }, {
    icon: TrendingUp,
    text: "Complete Career Support",
    desc: "Interview preparation and freelancing roadmap",
    slug: "career-guidance",
    gradient: "from-teal-500 to-cyan-500"
  }, {
    icon: BookOpen,
    text: "Industry Certifications",
    desc: "Get certified and recognized globally",
  ...
  const digitalMarketingCurriculum = [{
    ...
    icon: Globe,
    color: "from-blue-500 to-cyan-500",
    topics: ["Digital marketing ecosystem & channels", "Online consumer behavior", "Digital branding strategies", "Career paths & opportunities"]
  }, {
    title: "Website & Landing Page Fundamentals",
    slug: "website-landing-page-fundamentals",
    icon: Laptop,
    color: "from-purple-500 to-pink-500",
    topics: ["How websites work (domain, hosting, CMS)", "Website structure & UX basics", "Conversion-focused landing pages", "Lead generation strategies"]
  }, {
    title: "Search Engine Optimization (SEO)",
    slug: "search-engine-optimization",
    icon: Search,
    color: "from-green-500 to-emerald-500",
    topics: ["Keyword research & competitor analysis", "On-page SEO optimization", "Off-page SEO & link building", "Technical SEO (speed, mobile, indexing)", "Local SEO & Google Business profile optimization", "SEO audits & ranking strategies"]
  }, {
    title: "Content Marketing",
    slug: "content-marketing",
    icon: FileText,
    color: "from-amber-500 to-orange-500",
    topics: ["SEO-friendly blog writing", "Website & landing page content", "Ad copywriting fundamentals", "Content planning & calendars"]
  }, {
    title: "Social Media Marketing",
    slug: "social-media-marketing",
    icon: Share2,
    color: "from-rose-500 to-red-500",
    topics: ["Instagram, Facebook & LinkedIn strategies", "Organic growth techniques", "Content creation & scheduling", "Audience engagement & brand building"]
  }, {
    title: "Paid Advertising & Performance Marketing",
    slug: "paid-advertising-performance-marketing",
    icon: MousePointerClick,
    color: "from-indigo-500 to-blue-500",
    topics: ["Google Ads (Search, Display & Video)", "Social media paid advertising", "Budget planning & targeting", "Conversion tracking & optimization"]
  }, {
    title: "Email & WhatsApp Marketing",
    slug: "email-whatsapp-marketing",
    icon: MessageSquare,
    color: "from-teal-500 to-cyan-500",
    topics: ["Email marketing campaigns", "Lead nurturing & automation", "WhatsApp marketing strategies", "Customer retention techniques"]
  }, {
    title: "Analytics & Data Tracking",
    slug: "analytics-data-tracking",
    icon: BarChart3,
    color: "from-violet-500 to-purple-500",
    topics: ["Google Analytics fundamentals", "Traffic & user behavior analysis", "Conversion tracking", "Campaign performance reporting"]
  }, {
    title: "Online Reputation Management (ORM)",
    slug: "online-reputation-management",
    icon: Shield,
    color: "from-emerald-500 to-green-500",
    topics: ["Brand reputation monitoring", "Review & feedback handling", "Crisis management strategies", "Trust & credibility building"]
  }];
  const aiSkillsCurriculum = [{
    ...
    topics: ["AI-powered website builders", "No-code & low-code platforms", "AI-assisted UI/UX layouts", "High-conversion landing pages"]
  }, {
    title: "AI Graphic Designing",
    icon: Palette,
    color: "from-pink-500 to-rose-500",
    slug: "ai-graphic-designing",
    topics: ["AI logo & brand identity creation", "Social media creatives & ad banners", "Image enhancement & background removal", "Design automation using AI tools"]
  }, {
    title: "AI Video Editing & Creation",
    icon: Film,
    color: "from-purple-600 to-violet-500",
    slug: "ai-video-editing",
    topics: ["AI-based video editing tools", "Reels, Shorts & YouTube video creation", "AI subtitles, captions & voice-overs", "Multi-platform video optimization"]
  }];
  const practicalProjects = [{
    icon: Globe,
    text: "Website creation using AI tools",
    color: "from-blue-500 to-cyan-500"
  }, {
    icon: Search,
    text: "SEO audits on real websites",
    color: "from-green-500 to-emerald-500"
  }, {
    icon: Share2,
    text: "Social media marketing campaigns",
    color: "from-pink-500 to-rose-500"
  }, {
    icon: Palette,
    text: "AI-based graphic & video projects",
    color: "from-purple-500 to-violet-500"
  }, {
    icon: BarChart3,
    text: "Paid ads execution & optimization",
    color: "from-orange-500 to-amber-500"
  }, {
    icon: FileText,
    text: "Analytics dashboards & reports",
  ...
  const careerOpportunities = [{
    ...
    title: "Freelancer or Agency Owner",
    icon: Building2,
    color: "from-indigo-500 to-blue-500"
  }];
  const targetAudience = [{
    ...
    icon: GraduationCap,
    desc: "Start your digital career"
  }, {
    ...
    icon: Building2,
    desc: "Market your business online"
  }, {
    title: "Freelancers",
    icon: Laptop,
    desc: "Add new skills to your portfolio"
  }, {
    title: "Housewives",
    icon: Heart,
    desc: "Start earning from home"
  }, {
    title: "Career Changers",
    icon: TrendingUp,
    desc: "Switch to digital marketing"
  }];
  const certifications = ["Digital Marketing & AI Course Completion Certificate", "Practical Skill Certification", "Guidance for Google Ads & Analytics Certifications"];
  const careerSupport = [{
    text: "Interview preparation",
    icon: UserCheck
  }, {
    text: "Resume & portfolio building",
    icon: FileText
  }, {
    text: "Freelancing income roadmap",
    icon: CircleDollarSign
  }, {
    text: "Business & agency growth guidance",
    icon: Rocket
  }];
  const stats = [{
    value: 500,
  ...
  return <>
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
          <motion.div initial={{
            ...
            <motion.div initial={{
              ...
              <span className="text-xs sm:text-sm font-medium text-primary-foreground">6-Month Practical Training Program</span>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-8 sm:mb-12">
              ...
              <Button size="lg" variant="outline" className="border-slate-600 text-white hover:bg-slate-800 text-sm sm:text-base" onClick={() => window.location.href = '/digital-marketing-syllabus'}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
              {courseDetails.map((detail, index) => <motion.div key={index} initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                delay: 0.4 + index * 0.1
                  ...
                  <div className="relative p-4 sm:p-5 flex flex-col items-center text-center">
                    ...
                    {/* Label */}
                    <p className="text-[10px] uppercase tracking-wider mb-1 sm:text-sm font-bold text-slate-50">
                      {detail.label}
                    </p>
                    
                    {/* Value */}
                    <p className="text-sm sm:text-base font-bold leading-tight lg:text-sm text-center text-blue-100">
                      {detail.value}
                    </p>
                  </div>
                </motion.div>)}
      ...
      <section className="py-16 bg-gradient-primary relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <motion.div className="absolute top-0 left-0 w-64 h-64 bg-primary-foreground/20 rounded-full blur-3xl" animate={{
            x: [-20, 20, -20]
          }} transition={{
            duration: 8,
            repeat: Infinity,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {stats.map((stat, index) => <AnimatedSection key={stat.label} delay={0.1 * index}>
                <motion.div className="text-center p-4 sm:p-6 rounded-2xl bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/10" whileHover={{
                y: -5,
                scale: 1.02
              }}>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-muted/30 relative overflow-hidden">
        <motion.div className="absolute top-20 right-10 w-72 h-72 bg-primary/5 rounded-full blur-3xl" animate={{
          scale: [1, 1.2, 1]
        }} transition={{
          duration: 8,
          repeat: Infinity
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <AnimatedSection className="text-center mb-8 sm:mb-12 lg:mb-16">
            <motion.span className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-primary/10 text-primary rounded-full text-xs sm:text-sm font-semibold mb-4" whileHover={{
              scale: 1.05
            }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {benefits.map((benefit, index) => <AnimatedSection key={index} delay={index * 0.05}>
                <Link to={`/digital-marketing-academy/benefit/${benefit.slug}`}>
                  <motion.div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border hover:border-primary/50 transition-all duration-300 h-full group cursor-pointer relative overflow-hidden" whileHover={{
                  y: -8
                }}>
                    <motion.div className={`absolute inset-0 bg-gradient-to-br ${benefit.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
                    
                    <motion.div className={`w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br ${benefit.gradient} rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 relative`} whileHover={{
                    scale: 1.1,
                    rotate: 5
                  }}>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {digitalMarketingCurriculum.map((module, index) => <AnimatedSection key={index} delay={index * 0.05}>
                <Link to={`/digital-marketing-academy/module/${module.slug}`}>
                  <motion.div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border hover:border-primary/50 transition-all duration-300 h-full group cursor-pointer relative overflow-hidden" whileHover={{
                  y: -5
                }}>
                    <motion.div className={`absolute inset-0 bg-gradient-to-br ${module.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
                    
                    <div className="flex items-start gap-3 sm:gap-4">
                      <motion.div className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${module.color} rounded-lg sm:rounded-xl flex items-center justify-center`} whileHover={{
                      scale: 1.1,
                      rotate: 5
                    }}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <ul className="space-y-1">
                          {module.topics.slice(0, 3).map((topic, i) => <li key={i} className="flex items-start gap-1.5 text-[10px] sm:text-xs text-muted-foreground">
                              <CheckCircle2 className="w-3 h-3 text-primary flex-shrink-0 mt-0.5" />
                              <span className="line-clamp-1">{topic}</span>
                            </li>)}
                          {module.topics.length > 3 && <li className="text-[10px] sm:text-xs text-primary font-medium">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-primary/5 via-background to-accent/10 relative overflow-hidden">
        <motion.div className="absolute top-1/2 left-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-purple-500/10 rounded-full blur-3xl" animate={{
          scale: [1, 1.3, 1],
          rotate: [0, 180, 360]
        }} transition={{
          duration: 20,
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
            {aiSkillsCurriculum.map((module, index) => <AnimatedSection key={index} delay={index * 0.1}>
                <Link to={`/digital-marketing-academy/${module.slug}`} className="block h-full">
                  <motion.div className="bg-card rounded-2xl sm:rounded-3xl overflow-hidden border-2 border-border hover:border-primary/50 transition-all duration-300 h-full group cursor-pointer relative" whileHover={{
                  y: -10,
                  scale: 1.02
                }}>
                    <motion.div className={`absolute -inset-1 bg-gradient-to-br ${module.color} rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500`} />
                    
                    <div className={`bg-gradient-to-br ${module.color} p-4 sm:p-6 text-center relative overflow-hidden`}>
                      <motion.div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 relative z-10" whileHover={{
                      scale: 1.1,
                      rotate: 10
                    }}>
                    ...
                    <div className="p-4 sm:p-6 relative">
                      <ul className="space-y-2 sm:space-y-3">
                        {module.topics.map((topic, topicIndex) => <motion.li key={topicIndex} className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm" initial={{
                        opacity: 0,
                        x: -10
                      }} whileInView={{
                        opacity: 1,
        ...
        <section className="py-20 bg-muted/30 relative overflow-hidden">
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center mb-16">
              <motion.span className="inline-flex items-center gap-2 px-4 py-2 bg-secondary text-secondary-foreground rounded-full text-sm font-semibold mb-4" whileHover={{
              scale: 1.05
            }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {practicalProjects.map((project, index) => <AnimatedSection key={index} delay={index * 0.1}>
                  <motion.div className="bg-card rounded-2xl p-6 border border-border hover:border-primary/50 transition-all duration-300 group relative overflow-hidden" whileHover={{
                y: -5
              }}>
                    <motion.div className={`absolute inset-0 bg-gradient-to-br ${project.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
                    
                    <div className="flex items-center gap-4 relative">
                      <motion.div className={`w-14 h-14 bg-gradient-to-br ${project.color} rounded-xl flex items-center justify-center`} whileHover={{
                    scale: 1.1,
                    rotate: 5
                  }}>
        ...
        <section className="py-20 bg-background relative overflow-hidden">
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center mb-16">
              <motion.span className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-semibold mb-4" whileHover={{
              scale: 1.05
            }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {careerOpportunities.map((career, index) => <AnimatedSection key={index} delay={index * 0.05}>
                  <motion.div className="bg-card rounded-2xl p-6 border border-border hover:border-primary/50 transition-all duration-300 text-center group h-full relative overflow-hidden" whileHover={{
                y: -8,
                scale: 1.02
              }}>
                    <motion.div className={`absolute inset-0 bg-gradient-to-br ${career.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
                    
                    <motion.div className={`w-16 h-16 bg-gradient-to-br ${career.color} rounded-2xl flex items-center justify-center mx-auto mb-4 relative`} whileHover={{
                  scale: 1.1,
                  rotate: 10
                }}>
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <AnimatedSection direction="left">
                <motion.div className="bg-card rounded-3xl p-8 border border-border h-full relative overflow-hidden" whileHover={{
                scale: 1.02
              }}>
                  <motion.div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-2xl" animate={{
                  scale: [1, 1.3, 1]
                }} transition={{
                  duration: 4,
                  repeat: Infinity
                  ...
                  <div className="flex items-center gap-3 mb-6 relative">
                    <motion.div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl flex items-center justify-center" whileHover={{
                    rotate: 10
                  }}>
                  ...
                  <ul className="space-y-4 relative">
                    {certifications.map((cert, index) => <motion.li key={index} className="flex items-start gap-3" initial={{
                    opacity: 0,
                    x: -20
                  }} whileInView={{
                    opacity: 1,
              ...
              <AnimatedSection direction="right">
                ...
                scale: 1.02
                  ...
                  <motion.div className="absolute top-0 right-0 w-32 h-32 bg-green-500/10 rounded-full blur-2xl" animate={{
                  scale: [1, 1.3, 1]
                }} transition={{
                  duration: 4,
                  repeat: Infinity,
                  ...
                  <div className="flex items-center gap-3 mb-6 relative">
                    <motion.div className="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center" whileHover={{
                    rotate: 10
                  }}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative">
                    {careerSupport.map((support, index) => <motion.div key={index} className="flex items-center gap-3 p-3 bg-muted/50 rounded-xl hover:bg-muted transition-colors" whileHover={{
                    scale: 1.05,
                    x: 5
                  }} initial={{
                    opacity: 0,
        ...
        <section className="py-20 bg-muted/30 relative overflow-hidden">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {targetAudience.map((audience, index) => <AnimatedSection key={index} delay={index * 0.1}>
                  <motion.div className="bg-card rounded-2xl p-6 border border-border hover:border-primary/50 transition-all duration-300 group text-center relative overflow-hidden" whileHover={{
                y: -8
              }}>
                    <motion.div className="absolute inset-0 bg-gradient-to-br from-primary to-accent opacity-0 group-hover:opacity-5 transition-opacity duration-500" />
                    
                    <motion.div className="w-16 h-16 bg-gradient-to-br from-primary to-accent rounded-2xl flex items-center justify-center mx-auto mb-4 relative" whileHover={{
                  scale: 1.1,
                  rotate: 10
                }}>
        ...
        <section className="py-20 bg-gradient-to-br from-primary via-primary/90 to-accent relative overflow-hidden">
          {/* Decorative elements */}
          <motion.div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl" animate={{
          scale: [1, 1.2, 1],
          opacity: [0.1, 0.2, 0.1]
        }} transition={{
          duration: 6,
          ...
          <motion.div className="absolute bottom-0 left-0 w-72 h-72 bg-white/10 rounded-full blur-3xl" animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.2, 0.1, 0.2]
        }} transition={{
          duration: 6,
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection className="text-center max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-10">
                ...
                label: "Fees",
                value: "₹25,000/Month"
              }].map((item, index) => <motion.div key={item.label} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-white text-center border border-white/10" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-white/80">
                <motion.a href="mailto:info@dibull.com" className="flex items-center gap-2 hover:text-white transition-colors" whileHover={{
                scale: 1.05
              }}>
                ...
                <span className="hidden sm:inline">•</span>
                <motion.a href="https://wa.me/919824011921" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors" whileHover={{
                scale: 1.05
              }}>
