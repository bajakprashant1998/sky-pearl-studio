              ...
              {courseDetails.map((detail, index) => <motion.div key={index} initial={{
                ...
                delay: 0.4 + index * 0.1
                  ...
                  <div className="relative p-4 sm:p-5 flex flex-col items-center text-center">
                    ...
                    {/* Label */}
                    <p className="text-[10px] sm:text-xs uppercase tracking-wider font-medium mb-1 text-blue-50">
                      {detail.label}
                    </p>
                    
                    {/* Value */}
                    <p className="text-sm sm:text-base font-bold text-white leading-tight lg:text-sm">
                      {detail.value}
                    </p>
                  </div>
                </motion.div>)}
