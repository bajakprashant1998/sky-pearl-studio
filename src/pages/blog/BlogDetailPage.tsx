        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://dibull.com/blog" },
              { "@type": "ListItem", "position": 3, "name": post.category, "item": `https://dibull.com/blog?category=${encodeURIComponent(post.category)}` },
              { "@type": "ListItem", "position": 4, "name": post.title, "item": `https://dibull.com/blog/${post.slug}` }
            ]
          })}
        </script>
      </Helmet>
